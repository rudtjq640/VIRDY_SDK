...
namespace UnityEditor.Rendering.Universal
{
    ...
    public class SRDataEditor : Editor
    {
        class Styles
        {
        ...
        {
            EditorGUILayout.LabelField(Styles.RenderFeatures, EditorStyles.label);
            ...
            using (var hscope = new EditorGUILayout.HorizontalScope())
            {
                if (GUILayout.Button("Add Renderer Feature", EditorStyles.miniButton))
                {
                    ...
                    FilterWindow.Show(pos, new SRPProvider(this));
                }
            }
        }
        ...
        internal void AddComponent(string type)
        {
            ...
            {
                AssetDatabase.AddObjectToAsset(component, m_Target);
            }
